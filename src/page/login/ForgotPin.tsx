...
const ResetPin = () => {
	...
	const onSubmit = async (data: ResetFormData) => {
		...
		formData.append('PATRON_INT_ID', data.PATRON_INT_ID)
						...
						<div className="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-4 mt-4">
							<div className="flex-1">
								...
								<input
									...
									className={`p-2 w-full mt-1 border ${errors.PATRON_INT_ID ? 'border-red-500' : 'border-gray-300'}`}
								/>
