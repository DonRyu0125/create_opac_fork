				...
				<div className="bg-gray-50 min-h-screen py-10">
					<div className="max-w-4xl mx-auto bg-white shadow-md rounded-md p-6">
						...
						<div className="flex justify-between items-center border-b pb-4">
                            ...
                            <CircleCheck className='mr-2 text-green-500'/>Reproduction Confirmed
                            </h1>
						</div>
                        ...
                        <div>
							<div className="border p-4 rounded">
                                <div className='flex flex-row items-center'><Copy className='mr-2'/><h1 className="text-xl font-bold">Request Order Number: {reprodData.req_order_num}</h1></div>
