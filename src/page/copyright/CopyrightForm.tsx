						...
						<div className="py-4">
                            <form
                                ...
                                <div className="px-4 rounded grid grid-cols-2 gap-4">
                                    <div className=''>
                                        <Label htmlFor="firstName" className="block text-sm font-semibold mb-1">Email*</Label>
                                        <Input
                                        id="firstName"
                                        type="text"
                                        className="w-full p-2 border rounded mb-4"
                                    ...
                                    <div className=''>
                                        <Label htmlFor="reqAffiliation" className="block text-sm font-semibold mb-1">Affliation*</Label>
                                        <Input
                                        id="reqAffiliation"
                                        type="text"
                                        name="REQ_AFFILIATE"
                                ...
                                <div className="px-4 py-2 rounded grid grid-cols-1 gap-4">
                                    <div className='flex items-center'>
                                        <Label htmlFor="firstName" className="text-sm font-semibold mr-1">Rush</Label>
                                        <Checkbox
                                        id="firstName"
                                        className="rounded"
                                        name="REQ_RUSH"
                                ...
                                <div className="px-4 rounded grid grid-cols-1 mt-4">
                                    <Label htmlFor="reqDetail" className="block text-sm font-semibold mb-1">Additional Information*</Label>
