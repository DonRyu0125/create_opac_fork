						...
						<div className="py-4">
                            <form
                                ...
                                <div className="px-4 rounded grid grid-cols-2 gap-4">
                                    ...
                                    <div className=''>
                                        <Label htmlFor="lastName" className="block text-sm font-semibold mb-1">Phone Number</Label>
                                        <Input
                                        id="lastName"
                                        type="text"
                                        name="ENQ_TELEPHONE"
                                ...
                                <div className="px-4 rounded grid grid-cols-2 gap-4">
                                    <div className=''>
                                        <Label htmlFor="enqTopic" className="block text-sm font-semibold mb-1">Topic*</Label>
                                    ...
                                    <div className=''>
                                        <Label htmlFor="enqSubject" className="block text-sm font-semibold mb-1">Subject*</Label>
                                        <Input
                                        id="enqSubject"
                                        type="text"
                                        className="w-full p-2 border rounded"
