          ...
          <div className='grid md:grid-cols-2 gap-6 lg:gap-12 items-start max-w-6xl px-4 mx-auto py-6'>
            ...
            <div className='grid gap-4 md:gap-10 items-start'>
              <div className='grid gap-4'>
                ...
                <h2 className='text-xl text-gray-500'>by John Doe</h2>
                <div>
                  <p>
                    This is a detailed description of the book. It gives
                    potential readers a glimpse into the storyline, characters,
                    and setting of the book. It's designed to intrigue readers
                ...
                <div className='grid gap-2'>
                  <p>
                    <strong>Publication Date:</strong> January 1, 2024
                  </p>
                  <p>
              ...
              <div className='grid gap-4'>
                ...
                <div className='border rounded-lg p-4'>
                  ...
                  <p>
                    ...
                    were well-developed and the plot was intriguing. Can't wait
                    for the sequel!
                  </p>
                </div>
              </div>
