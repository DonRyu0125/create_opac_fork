...
const Header = () => {
	...
	const home_url = '?SEARCH&DATABASE=PATRON&REPORT=WEB_PATRON_PROFILE&EXP=patron_id+~3D+global(m2l_patron_id)'
						...
						<BreadcrumbItem>
							<BreadcrumbLink asChild>
								<Link
									...
									<UserCog className="mr-1 h-5 w-5" />
						...
						<DropdownMenuContent align="end">
							...
							<DropdownMenuItem>
								<Link
									href={
										getCookieValue('HOME_SESSID') +
										'?SEARCH&DATABASE=PATRON&REPORT=WEB_LIBRARY_CIRC_DASHBOARD&EXP=patron_id+~3D+global(m2l_patron_id)'
									}
									className="no-underline ml-[0.5rem]">
							...
							<DropdownMenuItem>
								<Link
									href={
										getCookieValue('HOME_SESSID') +
										'?SEARCH&DATABASE=PATRON&REPORT=WEB_CLIENT_ACC_SETTINGS&EXP=patron_id+~3D+global(m2l_patron_id)'
									}
									className="no-underline ml-[0.5rem]">
									{message.accountSettings}
								</Link>
