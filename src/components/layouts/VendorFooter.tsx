import { SiTwitter, SiLinkedin, SiFacebook, SiInstagram } from '@icons-pack/react-simple-icons'
		...
		<section id="footer">
			<div
				...
				<p className="mt-[25px] font-extralight leading-[32px] text-[13px] sm:text-[18px] text-ford-grey">
					Multimedia License Agreement | Images, video and audio from this Web site are
					provided for the purpose of editorial use only. You must contact
					archives@ford.com to obtain approval for advertising, marketing or other
					commercial users.
				</p>
				<p className="mt-[40px] text-[16px] text-ford-grey leading-[24px]">
					© {new Date().getFullYear()} The Ford Motor Company. All Rights Reserved.
				</p>
			</div>
			...
			<div
				...
				<div>
					...
					<div className="bg-black w-full h-auto px-[15px] pb-[30px] blackBoxCollapse collapse">
						<a className="mb-[8px]" href="https://corporate.ford.com/contact.html">
							Ford Motor Company
						</a>
						<a
							className="mb-[8px]"
					...
					<a
						className="mb-[8px]"
						href="https://shareholder.ford.com/investors/overview/default.aspx"></a>
				</div>
				<a
					className="mb-[8px]"
					href="https://shareholder.ford.com/investors/overview/default.aspx"></a>
				<div>
					...
					<div className="bg-black w-full h-auto px-[15px] pb-[30px] blackBoxCollapse collapse">
						...
						<a className="mb-[8px]" href="https://www.ford.com/support/recalls/">
							Recalls
						</a>
						<a
							className="mb-[8px]"
			...
			<div
				...
				<div className="flex flex-col lg:flex-row justify-evenly mt-[15px] ">
					<a
						...
						href="https://corporate.ford.com/about/copyright.html"
						target="_blank"></a>
					<a href="https://www.ford.com/help/contact/#accessibility" target="_blank">
						Accessibility
					</a>
					...
					<a href="https://www.ford.com/help/privacy/#caPrivacy" target="_blank">
