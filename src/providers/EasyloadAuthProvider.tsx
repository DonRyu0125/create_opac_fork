...
const TENANT =
	process.env.REACT_APP_EASYLOAD_TENANT 
	//|| import.meta.env.VITE_REACT_APP_EASYLOAD_TENANT
const PASSWORD =
	process.env.REACT_APP_EASYLOAD_PASSWORD 
	//|| import.meta.env.VITE_REACT_APP_EASYLOAD_PASSWORD
